	...
	namespace {
		...
		int GetTrackedResourceStatistics(luaext::State L) {
			...
			if (e->GetClassIdentifier() == GGL::CBuilding::Identifier) {
				...
				static constexpr auto add = [](Avg& a, double v) {
					if (v < 0.0)
						return;
					a.sum += v;
					++a.n;
		...
		bool MarketIsRes(shok::ResourceType rty) {
			return rty == shok::ResourceType::Clay || rty == shok::ResourceType::Gold || rty == shok::ResourceType::Iron || rty == shok::ResourceType::Stone ||
				rty == shok::ResourceType::Sulfur || rty == shok::ResourceType::Wood;
		}
		...
		constexpr std::array Settlers{
			...
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<EGL::CEventPosition, shok::EventIDs::HeroHawk_SendHawk,
																				LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilitySendHawk>>>(
				"CommandSendHawk"),
			...
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<BB::CEvent, shok::EventIDs::InflictFear_Activate,
																				LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityInflictFear>>>(
				"CommandInflictFear"),
			...
			luaext::FuncReference::GetRef<
				LuaEventInterface::EntityCommandEvent<GGL::CEventPositionAnd2EntityTypes, shok::EventIDs::CannonBuilder_BuildCannonCommand,
			...
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<BB::CEvent, shok::EventIDs::RangedEffect_Activate,
																				LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityRangedEffect>>>(
				"CommandRangedEffect"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<BB::CEvent, shok::EventIDs::CircularAttack_ActivateCommand,
																				LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityCircularAttack>>>(
				"CommandCircularAttack"),
			...
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<
				BB::CEvent, shok::EventIDs::Camouflage_Activate, LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityCamouflage>, CheckCamoEvent>>(
				"CommandActivateCamoflage"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<
				EGL::CEvent1Entity, shok::EventIDs::ConvertSettler_ActivateCommand, LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityConvertSettlers>,
				LuaEventInterface::CheckSettler, LuaEventInterface::CheckConvertible, LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile>>>(
				"CommandConvert"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<
				EGL::CEvent1Entity, shok::EventIDs::Sniper_SnipeCommand, LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilitySniper>,
				LuaEventInterface::CheckSettler, LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile>, CheckSnipeEvent>>("CommandSnipe"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<
			...
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<EGL::CEvent1Entity, shok::EventIDs::KegPlacer_SabotageCommand,
																				...
																				LuaEventInterface::CheckBuilding, CheckThiefNotCarryingEvent, CheckSabotageEvent>>(
				"CommandSabotage"),
			...
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<EGL::CEventPosition, shok::EventIDs::Binocular_ExploreCommand,
																				LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityScoutBinoculars>>>(
				"CommandBinocular"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<EGL::CEventPosition, shok::EventIDs::TorchPlacer_PlaceTorch,
																				LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityScoutTorches>>>(
				"CommandPlaceTorch"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<BB::CEvent, shok::EventIDs::PointToResources_Activate,
																				LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityScoutFindResources>>>(
				"CommandPointToRes"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::EntityCommandEvent<EGL::CEvent1Entity, shok::EventIDs::Thief_StealFromCommand, CheckIsThief, LuaEventInterface::CheckBuilding,
													  LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile>>>("CommandStealFrom"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<
				EGL::CEvent1Entity, shok::EventIDs::Thief_StealFromCommand, CheckIsThief, LuaEventInterface::CheckBuilding,
				LuaEventInterface::CheckTargetCategory<shok::EntityCategory::Headquarters>, LuaEventInterface::CheckEntityDiploState<shok::DiploState::Friendly>>>(
				"CommandSecureGoods"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::EntityCommandEvent<EGL::CEventPosition, shok::EventIDs::CppL_LightningStrike_Activate,
													  LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityLightningStrike>, CheckLightingStrike>>(
				"CommandLightningStrike"),
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<
				EGL::CEvent1Entity, shok::EventIDs::CppL_ResDoodadRefill_Activate, LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbiltyResourceDoodadRefill>,
				LuaEventInterface::CheckBuilding, CheckResourceRefill, LuaEventInterface::CheckEntityDiploState<shok::DiploState::Friendly>>>(
				"CommandRefillResourceDoodad"),
			...
			luaext::FuncReference::GetRef<
				LuaEventInterface::EntityCommandEvent<EGL::CEventPosition, shok::EventIDs::CppL_Bombardment_Activate,
													  LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityBombardment>, CheckBombardment>>(
				"CommandBombardment"),
			...
			luaext::FuncReference::GetRef<LuaEventInterface::EntityCommandEvent<EGL::CEvent1Entity, shok::EventIDs::HeroBehavior_CommandNPCInteraction,
																				...
																				LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile, true>>>(
				"CommandNPCInteraction"),
...
// local x,y = GUI.Debug_GetMapPositionUnderMouse();  for id,r in CppLogic.Entity.EntityIterator(CppLogic.Entity.Predicates.OfAnyEntityType(Entities.PU_Serf,
// Entities.PB_Headquarters1), CppLogic.Entity.Predicates.InCircle(x,y, 1000)) do LuaDebugger.Log(id.."   "..r) end
