...
namespace CppLogic::Logic {
	namespace {
		...
		int GetTradeDataForResource(luaext::State L) {
			...
			if (rt != shok::ResourceType::Gold && rt != shok::ResourceType::Stone && rt != shok::ResourceType::Iron && rt != shok::ResourceType::Sulfur &&
				rt != shok::ResourceType::Clay && rt != shok::ResourceType::Wood)
		...
		int EnableRefillableMineNoAutoDestroy(luaext::State L) {
			CppLogic::SavegameExtra::SerializedMapdata::GlobalObj.ResDoodad_RefillableCategory =
				L.IsNoneOrNil(1) ? shok::EntityCategory::Invalid : L.CheckEnum<shok::EntityCategory>(1);
	...
	void OnSaveLoaded(luaext::State L) {
		...
		if (CppLogic::SavegameExtra::SerializedMapdata::GlobalObj.ResourceTriggers || CppLogic::SavegameExtra::SerializedMapdata::GlobalObj.RefinerFix)
			EnableResourceTriggers(CppLogic::SavegameExtra::SerializedMapdata::GlobalObj.ResourceTriggers,
								   CppLogic::SavegameExtra::SerializedMapdata::GlobalObj.RefinerFix);
