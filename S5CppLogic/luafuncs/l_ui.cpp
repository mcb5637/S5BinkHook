...
namespace CppLogic::UI {
	namespace {
		...
		int SetGUIStateLuaSelection(luaext::State L) {
			...
			vh->StateIdManager->GetIDByNameOrCreate(Mod::GUIState::GUIState_LuaSelection::Name,
													Mod::GUIState::GUIState_LuaSelection::Id); // make sure the state id exists
			vh->SetGUIState<Mod::GUIState::GUIState_LuaSelection>();
			auto* s = dynamic_cast<Mod::GUIState::GUIState_LuaSelection*>(vh->CurrentState);
			L.PushValue(1);
		...
		int SetGUIStatePlaceBuildingEx(luaext::State L) {
			auto* vh = GGUI::CManager::GlobalObj()->C3DViewHandler;
			vh->StateIdManager->GetIDByNameOrCreate(Mod::GUIState::GUIState_PlaceBuildingEx::Name, Mod::GUIState::GUIState_PlaceBuildingEx::Id); // make sure the state id exists
			GGUI::SPlaceBuildingStateParameters p{L.CheckEnum<shok::UpgradeCategoryId>(1)};
			vh->SetGUIState<Mod::GUIState::GUIState_PlaceBuildingEx>(&p);
			auto* state = BB::IdentifierCast<Mod::GUIState::GUIState_PlaceBuildingEx>(vh->CurrentState);
		...
		int SetPlaceBuildingRotation(luaext::State L) {
			...
			auto* s = dynamic_cast<Mod::GUIState::GUIState_PlaceBuildingEx*>(GGUI::CManager::GlobalObj()->C3DViewHandler->CurrentState);
			if (s) {
		...
		int CreateShortMessage(luaext::State L) {
			...
			mes->StandardMessage.Add(static_cast<GGUI::CShortMessagesWindowControllerCustomWidget::MessageType>(L.CheckInt(1)), nullptr, L.CheckFloat(2), p,
									 L.CheckString(3));
			return 0;
		}
	...
	CppLogic::UI::TerrainDecalAccess::TerrainDecalAccess(ED::CTerrainDecalBase* d) : Decal(d) {
		Actives.insert(this);
	}
	...
	namespace {
		...
		int CommandDonateResources(luaext::State L) {
			GGL::CNetEventPlayerResourceDonation ev{
				shok::NetEventIds::Player_SendMPResources,
		...
		constexpr std::array Commands{
			...
			luaext::FuncReference::GetRef<LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Serf_ConstructBuilding, CheckConstruct>>(
				"Serf_ConstructBuilding"),
			luaext::FuncReference::GetRef<LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Serf_RepairBuilding, CheckRepair>>(
				"Serf_RepairBuilding"),
			luaext::FuncReference::GetRef<LuaEventInterface::NetEvent<GGL::CNetEventExtractResource, shok::NetEventIds::Serf_ExtractResource, CheckExtract>>(
				"Serf_ExtractResource"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEventEntityAndPos, shok::NetEventIds::Entity_AttackPos, LuaEventInterface::CheckEntityOfLocalPlayer>>(
				"Entity_AttackPos"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Entity_GuardEntity, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityDiploState<shok::DiploState::Friendly>>>("Entity_GuardEntity"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEventEntityAndPos, shok::NetEventIds::BombPlacer_PlaceBombAt, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityPlaceBomb>>>("BombPlacer_PlaceBombAt"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<GGL::CNetEventCannonCreator, shok::NetEventIds::CannonPlacer_HeroPlaceCannonAt, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityBuildCannon>, CheckPlaceCannonEvent>>(
				"CannonPlacer_HeroPlaceCannonAt"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Hero_NPCInteraction, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityActorCategory<shok::EntityCategory::Hero>>>("Hero_NPCInteraction"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::ConvertSettler_Convert, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckActorAbility<shok::AbilityId::AbilityConvertSettlers>, LuaEventInterface::CheckConvertible,
											LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile>, LuaEventInterface::CheckSettler>>(
				"ConvertSettler_Convert"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Thief_StealFrom, LuaEventInterface::CheckEntityOfLocalPlayer, CheckIsThief,
											LuaEventInterface::CheckBuilding, LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile>>>("Thief_StealFrom"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Thief_CarryStolenStuffToHQ, LuaEventInterface::CheckEntityOfLocalPlayer,
			...
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Sabotage_Sabotage, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckActorAbility<shok::AbilityId::AbilityPlaceKeg>, LuaEventInterface::CheckBuilding,
											CheckThiefNotCarryingEvent, CheckSabotageEvent>>("Sabotage_Sabotage"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Sabotage_Defuse, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckActorAbility<shok::AbilityId::AbilityPlaceKeg>, CheckThiefNotCarryingEvent, CheckSabotageEvent>>(
				"Sabotage_Defuse"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEventEntityAndPos, shok::NetEventIds::Binoculars_Observe, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityScoutBinoculars>>>("Binoculars_Observe"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Sniper_Snipe, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckActorAbility<shok::AbilityId::AbilitySniper>, CheckSnipeEvent, LuaEventInterface::CheckSettler,
											LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile>>>("Sniper_Snipe"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEventEntityAndPos, shok::NetEventIds::TorchPlacer_Place, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityScoutTorches>>>("TorchPlacer_Place"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::Shuriken_Activate, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckActorAbility<shok::AbilityId::AbilityShuriken>, CheckShurikenEvent, LuaEventInterface::CheckSettler,
											LuaEventInterface::CheckEntityDiploState<shok::DiploState::Hostile>>>("Shuriken_Activate"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEventEntityAndPos, shok::NetEventIds::CppL_LightningStrike_Activate, CheckLightingStrike,
											LuaEventInterface::CheckEntityOfLocalPlayer, LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityLightningStrike>>>(
				"LightningStrike_Activate"),
			luaext::FuncReference::GetRef<LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::CppL_ResDoodadRefill_Activate,
																	  ...
																	  LuaEventInterface::CheckActorAbility<shok::AbilityId::AbiltyResourceDoodadRefill>>>(
				"ResDoodadRefill_Activate"),
			luaext::FuncReference::GetRef<LuaEventInterface::NetEvent<EGL::CNetEventEntityID, shok::NetEventIds::CppL_ShieldCover_Activate,
																	  LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityShieldCover>>>(
				"ShieldCover_Activate"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEvent2Entities, shok::NetEventIds::CppL_Resurrect_Activate, LuaEventInterface::CheckEntityOfLocalPlayer,
											CheckResurrectEvent, LuaEventInterface::CheckActorAbility<shok::AbilityId::AbilityResurrect>>>("Resurrect_Activate"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEventEntityAndPos, shok::NetEventIds::CppL_BombardmentActivate, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityBombardment>>>("Bombardment_Activate"),
			luaext::FuncReference::GetRef<
				LuaEventInterface::NetEvent<EGL::CNetEventEntityAndPos, shok::NetEventIds::CppL_BombComboCannonActivate, LuaEventInterface::CheckEntityOfLocalPlayer,
											LuaEventInterface::CheckEntityAbility<shok::AbilityId::AbilityPlaceBomb>,
	...
	void Init(luaext::State L) {
		...
		if (L.GetState() == shok::LuaStateMainmenu) {
			...
			Mod::GUIState::GUIState_LuaSelection::Initialize();
			Mod::GUIState::GUIState_PlaceBuildingEx::Initialize();
		}
	}
} // namespace CppLogic::UI
