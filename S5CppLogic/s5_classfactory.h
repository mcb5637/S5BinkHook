...
namespace BB {
	...
	struct FieldSerializer {
		...
		template<>
		static constexpr BB::FieldSerializer* GetSerializer<shok::EventIDs>() {
			return TypeInt; // no real serializer, but int should work
		}
		template<>
		...
		template<>
		static constexpr BB::FieldSerializer* GetSerializer<shok::ModelId>() {
			return TypeModel;
		}
		template<>
		static constexpr BB::FieldSerializer* GetSerializer<shok::AnimationId>() {
			return TypeAnim;
		}
	...
	template<>
	static constexpr SerializationData SerializationData::AutoDataHolder<BB::IObject*>::AutoData(const char* name, size_t pos, size_t size) {
