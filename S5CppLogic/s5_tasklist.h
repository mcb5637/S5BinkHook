...
namespace shok {
    enum class Task : int {
        ...
        TASK_BATTLE_WAIT_UNTIL = 129, // waits BattleWaitUntil from tasklist start
        TASK_TRAIN = 130,
        ...
        TASK_WAIT_FOR_LATEST_ATTACK = 175, // waits BattleWaitUntil from the tick last set by  TASK_SET_LATEST_ATTACK_TURN
