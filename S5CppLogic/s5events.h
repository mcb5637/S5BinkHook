...
struct shok_BB_CMouseEvent : shok_BB_CInputEvent {
	shok_Keys KeyData; // 3 Keys.XXX modifiers bitfield
	...
	shok_BB_CMouseEvent(shok_InputEventIds id, shok_Keys keydata, int clicks, int x, int y, int delta);
	...
	bool IsKey(shok_Keys key);
	bool IsModifier(shok_Keys mod);
