...
struct shok_BB_CEvent : shok_BB_IObject {
	...
	shok_BB_CEvent(shok_InputEventIds eventid);
	...
	bool IsEvent(shok_EventIDs id);
	bool IsEvent(shok_NetEventIds id);
	bool IsEvent(shok_FeedbackEventIds id);
	bool IsEvent(shok_InputEventIds id);
...
struct shok_GGL_CEventAttachmentTypeGetInteger : shok_BB_CEvent {
	...
	shok_GGL_CEventAttachmentTypeGetInteger(shok_EventIDs e, shok::AttachmentType t);
...
struct shok_GGL_CEventAttachmentTypeInteger : shok_BB_CEvent {
	...
	shok_GGL_CEventAttachmentTypeInteger(shok_EventIDs e, shok::AttachmentType t, int d);
...
struct shok_GGL_CEventTransaction : shok_BB_CEvent {
	...
	shok_GGL_CEventTransaction(shok_EventIDs e, shok::ResourceType sell, shok::ResourceType buy, float buyAm);
...
struct shok_GGL_CEventEntityAttachment : shok_BB_CEvent {
	...
	shok_GGL_CEventEntityAttachment(shok_EventIDs e, shok::AttachmentType ty, int eid, shok_EventIDs detach);
...
struct shok_GGL_CNetEventExtractResource : shok_BB_CEvent {
	...
	shok_GGL_CNetEventExtractResource(shok_NetEventIds id, int ent, shok::ResourceType resty, const shok::Position& pos);
...
struct shok_GGL_CNetEventTransaction : shok_BB_CEvent {
	...
	shok_GGL_CNetEventTransaction(shok_NetEventIds shok_NetEventIds, int ent, shok::ResourceType sell, shok::ResourceType buy, int buyam);
...
struct shok_BB_CInputEvent : shok_BB_CEvent {
	bool EventHandeled; // needs confimration, no seridata
	PADDING(3);

	shok_BB_CInputEvent(shok_InputEventIds id);
	shok_BB_CInputEvent(shok_BB_CInputEvent&&) = default;
	shok_BB_CInputEvent(const shok_BB_CInputEvent&) = default;
	shok_BB_CInputEvent& operator=(shok_BB_CInputEvent&&) = default;
	shok_BB_CInputEvent& operator=(const shok_BB_CInputEvent&) = default;

	static inline constexpr int TypeDesc = 0x7FFE3C;
	static inline constexpr int vtp = 0x762124;
};
struct shok_BB_CMouseEvent : shok_BB_CInputEvent {
	...
	shok_BB_CMouseEvent(shok_InputEventIds id, shok::Keys keydata, int clicks, int x, int y, int delta);
	shok_BB_CMouseEvent(shok_BB_CMouseEvent&&) = default;
	shok_BB_CMouseEvent(const shok_BB_CMouseEvent&) = default;
...
struct shok_BB_CKeyEvent : shok_BB_CInputEvent {
	...
	shok_BB_CKeyEvent(shok_InputEventIds id, shok::Keys keydata);
...
struct shok_BB_CKeyPressEvent : shok_BB_CInputEvent {
	...
	shok_BB_CKeyPressEvent(shok_InputEventIds id, int keychar, shok::Keys keymodif);
