...
namespace RWE {
	...
	enum class RwCorePluginID : int {
		...
		// lots more...
		MORPHPLUGIN = MAKECHUNKID(RwPluginVendor::rwVENDORID_CRITERIONTK, 0x05),
		SKINPLUGIN = MAKECHUNKID(RwPluginVendor::rwVENDORID_CRITERIONTK, 0x16),
		...
		UVANIMPLUGIN = MAKECHUNKID(RwPluginVendor::rwVENDORID_CRITERIONTK, 0x35),
...
template<>
class enum_is_flags<RWE::RwCameraClearMode> : public std::true_type {};
template<>
class enum_is_flags<RWE::RwMatrixType> : public std::true_type {};
template<>
class enum_is_flags<RWE::RwVideoModeFlag> : public std::true_type {};
template<>
class enum_is_flags<RWE::RwIm3DTransformFlags> : public std::true_type {};
template<>
class enum_is_flags<RWE::RwRasterCreateFlags> : public std::true_type {};
template<>
class enum_is_flags<RWE::RwRasterLockMode> : public std::true_type {};
template<>
class enum_is_flags<RWE::RpGeometryFlag> : public std::true_type {};