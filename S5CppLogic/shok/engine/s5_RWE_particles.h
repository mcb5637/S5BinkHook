...
template<>
class enum_is_flags<RWE::Particles::EmitterClassId> : public std::true_type {};
template<>
class enum_is_flags<RWE::Particles::ParticleClassId> : public std::true_type {};
template<>
class enum_is_flags<RWE::Particles::RpPTankDataFlags> : public std::true_type {};
