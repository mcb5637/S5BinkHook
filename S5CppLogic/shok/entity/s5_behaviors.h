...
namespace EGL {
	...
	class CSlotParticleEffectAttachment : public EGL::TSlot<EGL::SSlotArgsParticleEffectAttachment, 0xD01A7907> {
	public:
...
namespace GGL {
	...
	public:
		...
		static void HookBuyTrigger();
	private:
		void EventBuyCannonOverride(EGL::CEventValue_Int* ev);
	};
