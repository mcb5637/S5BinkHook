...
void Framework::SavegameSystem::HookSavegameValid()
{
    ...
    auto* p = &lua::State::CppToCFunction<SavegameValidOverride>;
    CppLogic::Hooks::WriteJump(reinterpret_cast<void*>(0x40D0F0), p, reinterpret_cast<void*>(0x40D0FA));
}
...
{
    const auto f = reinterpret_cast<void (__stdcall*)(CEventTimeManager*, BB::CEvent*)>(0x40e1ee);
    f(this, ev);
}
void __stdcall Framework::CCheckSumCalculator::PostEvent(BB::CEvent* ev)
{
    const auto f = reinterpret_cast<void (__stdcall*)(CCheckSumCalculator*, BB::CEvent*)>(0x40e91f);
    f(this, ev);
}
void __stdcall Framework::CEscapeEventHandler::PostEvent(BB::CEvent* ev)
{
    const auto f = reinterpret_cast<void (__stdcall*)(CEscapeEventHandler*, BB::CEvent*)>(0x40e69f);
    f(this, ev);
}
...
void Framework::AGameModeBase::HookLoadSave()
{
    ...
    CppLogic::Hooks::WriteJump(reinterpret_cast<void*>(0x40FB6E), &OnSaveLoadedExASM, reinterpret_cast<void*>(0x40FB76));
    ...
    CppLogic::Hooks::WriteJump(reinterpret_cast<void*>(0x40FA71), &LoadSaveCheckIsSaveValidASM, reinterpret_cast<void*>(0x40FA76));
}

void __stdcall Framework::CSinglePlayerMode::CNetworkEvent::PostEvent(BB::CEvent* ev)
{
    const auto f = reinterpret_cast<void (__stdcall*)(CNetworkEvent*, BB::CEvent*)>(0x40f952);
    f(this, ev);
}
void __stdcall Framework::CMultiPlayerMode::CNetworkEvent::PostEvent(BB::CEvent* ev)
{
    const auto f = reinterpret_cast<void (__stdcall*)(CNetworkEvent*, BB::CEvent*)>(0x40f31b);
    f(this, ev);
}
