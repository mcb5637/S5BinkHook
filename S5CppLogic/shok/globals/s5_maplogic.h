...
namespace EGL {
	...
	public:
		...
		int* GetBridgeHeightP(int x, int y);
		static int* __thiscall GetBridgeHeightPStatic(CGLETerrainLowRes* th, int x, int y);
...
template<>
class enum_is_flags<EGL::CGLELandscape::BlockingMode> : public std::true_type {};
